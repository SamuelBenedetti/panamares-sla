...
export default function CTA() {
  return (
    <section className="relative bg-[#121e3e] py-14 md:py-[80px] px-6 xl:px-[20px] 2xl:px-[120px] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-4 items-center text-center max-w-[1600px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          <a
            ...
            className="bg-[#00b424] text-white font-body font-medium text-[15px] px-5 py-2.5 h-[42px] flex items-center justify-center gap-[8px] hover:bg-[#009e1f] transition-colors shadow-[0px_1px_2px_rgba(0,0,0,0.05)]"
          >
          ...
          <Link
            href="/contacto/"
            className="bg-white text-[#0d1835] font-body font-medium text-[15px] px-5 py-2.5 h-[42px] flex items-center justify-center hover:bg-white/90 transition-colors"
          >
            Contáctenos Ahora
          </Link>
        </div>
