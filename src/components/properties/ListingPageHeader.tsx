...
function DescriptionText({ text }: { text: string }) {
  ...
  if (dotIdx === -1) {
    return (
      <p className="font-body font-normal text-[16px] text-[#0c1834] leading-[22px] tracking-[-0.32px] max-w-[850px]">
        {text}
      </p>
    );
  }
  ...
  return (
    <p className="font-body text-[16px] text-[#0c1834] leading-[22px] tracking-[-0.32px] max-w-[850px]">
