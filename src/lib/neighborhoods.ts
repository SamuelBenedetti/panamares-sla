...
export const NEIGHBORHOODS: NeighborhoodConfig[] = [
  ...
  { slug: "san-francisco", name: "San Francisco", priority: "LOW" },
  { slug: "via-porras", name: "Vía Porras", priority: "LOW" },
  { slug: "bella-vista", name: "Bella Vista", priority: "LOW" },
  ...
  { slug: "panama", name: "Panama", priority: "LOW" },
];
