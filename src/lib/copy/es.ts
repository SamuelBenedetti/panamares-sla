...
export const es: Copy = {
  ...
  pages: {
    ...
    barriosIndex: {
      meta: {
        title: "TODO_PR2_pages.barriosIndex.meta.title",
        description: "TODO_PR2_pages.barriosIndex.meta.description",
      },
      todoPr2Marker: "TODO_PR2_pages.barriosIndex",
    },
    agentesIndex: {
      meta: {
        title: "TODO_PR2_pages.agentesIndex.meta.title",
        description: "TODO_PR2_pages.agentesIndex.meta.description",
      },
      todoPr2Marker: "TODO_PR2_pages.agentesIndex",
    },
    propiedadesEnVenta: {
      meta: {
