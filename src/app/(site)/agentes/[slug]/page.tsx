      ...
      <section className="bg-[#121e3e] px-[30px] xl:px-[60px] 2xl:px-[160px] py-[70px] xl:py-[90px]">
        <div className="max-w-[1440px] mx-auto flex flex-col xl:flex-row xl:items-center xl:justify-between gap-[32px]">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-1.5 bg-[#00b424] hover:bg-[#009e1f] w-full xl:w-fit px-[32px] py-[15px] font-body font-medium text-[14px] text-white tracking-[1.4px] uppercase transition-colors whitespace-nowrap shadow-sm"
          >
