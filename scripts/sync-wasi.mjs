...
// `decodeHtmlEntities` and the `HTML_ENTITIES` lookup live in
// `./lib/decode-html-entities.mjs` so the one-shot migration script can
// reuse the same logic. See that module for the full rationale.
